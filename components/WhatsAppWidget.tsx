    ...
    <div className="whatsapp-widget-container">
      ...
      {isOpen && (
        <div className="whatsapp-popup">
          ...
          <form onSubmit={handleSend} className="whatsapp-popup-form">
            {/* Inquiry Type */}
            <div>
            ...
            {inquiryType === "booking" ? (
              <>
                ...
                {/* Guests */}
                <div className="whatsapp-guests-row">
                  <div className="whatsapp-guests-field">
                    <label className="whatsapp-label">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="whatsapp-input whatsapp-textarea"
                />
              </div>
            )}
